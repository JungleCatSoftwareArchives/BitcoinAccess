...
public class GetUnconfirmedBalance extends AsyncTask<TextView,Integer,String> {
	...
	public GetUnconfirmedBalance(Context context){
		super();
	...
	protected String doInBackground(TextView... textViews) {
		...
		return BitcoinRPC.getBalance(context,0);
	}
